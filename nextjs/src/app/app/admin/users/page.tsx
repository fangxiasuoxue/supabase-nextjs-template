        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="flex flex-col gap-2">
                <div className="flex items-center gap-2 text-cyan-600 mb-1">
                    ...
                    <span className="text-[10px] uppercase tracking-[0.2em] font-black text-cyan-600">Admin Control / Access Management</span>
                </div>
                <h1 className="text-4xl font-black tracking-tight text-foreground">用户管理 <span className="text-cyan-600">.</span></h1>
