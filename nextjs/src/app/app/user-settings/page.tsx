    ...
    return (
        <div className="space-y-10 animate-in fade-in slide-in-from-bottom-8 duration-1000 ease-[cubic-bezier(0.2,0.8,0.2,1)]">
            <div className="flex flex-col gap-4 relative">
                <div className="flex items-center gap-3 text-cyan-600 mb-1 group cursor-default">
                    <div className="p-2 rounded-lg bg-cyan-50 border border-cyan-100 group-hover:bg-cyan-100 transition-colors">
                        <User className="h-4 w-4" />
                    </div>
                    <div className="flex flex-col">
                        <span className="text-[10px] uppercase tracking-[0.3em] font-black text-cyan-600">User Command Interface</span>
                ...
                <h1 className="text-5xl font-black tracking-tighter text-foreground leading-none">
                    {t('user.title')} <span className="text-cyan-600">.</span>
                </h1>
                <p className="text-muted-foreground/80 max-w-2xl text-sm font-medium leading-relaxed">{t('user.desc')}</p>
            </div>

            {error && (
                <Alert className="bg-red-50 border-red-200 text-red-700 rounded-2xl p-4 animate-in zoom-in-95 duration-300">
            ...
            {success && (
                <Alert className="bg-green-50 border-green-200 text-green-700 rounded-2xl p-4 animate-in zoom-in-95 duration-300">
            ...
            <div className="grid gap-10 xl:grid-cols-3">
                <div className="xl:col-span-2 space-y-10">
                    {/* Identity Matrix */}
                    <div className="glass-card-premium p-10 rounded-[2.5rem] relative overflow-hidden group">
                        ...
                        <div className="grid md:grid-cols-2 gap-8 relative z-10">
                            <div className="p-6 rounded-2xl bg-slate-50 border border-slate-200 space-y-2 hover:border-cyan-200 transition-colors group/item">
                                <label className="text-[10px] uppercase font-black text-muted-foreground tracking-widest block opacity-60 group-hover/item:text-cyan-600 transition-colors">{t('user.email')}</label>
                                <p className="text-base font-black tech-mono text-foreground break-all">{user?.email}</p>
                            </div>
                            <div className="p-6 rounded-2xl bg-slate-50 border border-slate-200 space-y-2 hover:border-cyan-200 transition-colors group/item">
                                <label className="text-[10px] uppercase font-black text-muted-foreground tracking-widest block opacity-60 group-hover/item:text-cyan-600 transition-colors">{t('user.id')}</label>
                    ...
                    <div className="glass-card-premium p-10 rounded-[2.5rem] relative overflow-hidden group">
                        <div className="absolute top-0 right-0 w-64 h-64 bg-amber-100/50 blur-[100px] -mr-32 -mt-32 group-hover:bg-amber-100 transition-colors" />
                        ...
                        <form onSubmit={handlePasswordChange} className="space-y-8 max-w-md relative z-10">
                            <div className="space-y-6">
                                <div className="space-y-3">
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-white border border-slate-300 text-slate-900 rounded-2xl h-14 px-5 focus:ring-1 focus:ring-cyan-600/20 focus:border-cyan-600 outline-none tech-mono text-base transition-all placeholder:text-slate-400"
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="bg-cyan-600 hover:bg-cyan-700 text-white w-full rounded-2xl h-14 font-black uppercase tracking-[0.3em] text-[11px] transition-all flex items-center justify-center gap-3 shadow-sm active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                                {loading ? (
                                    <>
                    ...
                    <div className="glass-card-premium p-2 rounded-[2.5rem] overflow-hidden relative group">
                         <div className="absolute top-0 right-0 w-64 h-64 bg-cyan-100/50 blur-[100px] -mr-32 -mt-32 group-hover:bg-cyan-100 transition-colors" />
                ...
                <div className="space-y-10">
                    <div className="glass-card-premium p-8 rounded-[2.5rem] border-cyan-200 bg-cyan-50 relative overflow-hidden group/sec">
                        <div className="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-transparent via-cyan-500 to-transparent opacity-50" />
                        <h3 className="text-[10px] font-black uppercase tracking-[0.3em] text-cyan-700 mb-8 text-center">System Security Status</h3>
                        <div className="flex flex-col items-center gap-8 py-4 relative z-10">
                            <div className="relative">
                                <div className="w-24 h-24 rounded-full bg-green-50 border-2 border-green-200 flex items-center justify-center group-hover/sec:scale-105 transition-transform duration-500">
                            ...
                            <div className="text-center space-y-2">
                                ...
                                <div className="flex flex-col gap-1">
                                    ...
                                    <span className="text-[8px] text-cyan-600 font-black uppercase tracking-[0.3em] tech-mono">AES_256_GCM_ACTIVE</span>
                                </div>
                            </div>
                        </div>

                        <div className="mt-10 pt-8 border-t border-cyan-200 space-y-4">
                            <div className="flex justify-between items-center text-[9px] font-black uppercase tracking-widest">
                                <span className="text-muted-foreground/60">Risk Assessment</span>
                                <span className="text-green-600">Low / Optimal</span>
                            </div>
                    ...
                    <div className="glass-card-premium p-8 rounded-[2.5rem] relative overflow-hidden group/tip">
                        <div className="flex items-start gap-4 relative z-10">
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-[10px] font-bold text-muted-foreground/60 leading-relaxed uppercase">
                                    ...
                                    <br />
                                    开启 <span className="text-cyan-700">MFA 二步验证</span> 后可获得最高级别的防御态势。
                                </p>
                            </div>
                        </div>
                    </div>
