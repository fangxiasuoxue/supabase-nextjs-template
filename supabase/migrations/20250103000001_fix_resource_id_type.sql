-- Migration: Fix resource_id column type in resource_assignments
-- Change resource_id from UUID to BIGINT to match ip_assets and other resource tables
...
CREATE TABLE public.resource_assignments (
  ...
  resource_id BIGINT NOT NULL,   -- ID of the actual resource (changed from UUID to BIGINT)
